...
set_target_properties(Parquet::parquet_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "C:/Users/hp/anaconda3/Library/parquet.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/parquet.dll"
  )

list(APPEND _cmake_import_check_targets Parquet::parquet_shared )
list(APPEND _cmake_import_check_files_for_Parquet::parquet_shared "C:/Users/hp/anaconda3/Library/parquet.lib" "${_IMPORT_PREFIX}/bin/parquet.dll" )
